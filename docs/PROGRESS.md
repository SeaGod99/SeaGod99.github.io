...
**最後更新**：2026-06-16（表情/探索筆記/樂譜三頁面新增；emotes 繁中名待補；exploration-log 座標與繁中景觀名待補）
...
5. 其餘收藏追蹤頁（樂譜/表情/髮型/肖像/時尚裝備/探索筆記）
6. 其他規劃：B 怪路線、時尚品鑑、冒險者小隊計算機、優雷卡天氣 NM、藏寶圖、園藝配種、釣魚紀錄
7. 製作利潤計算機（繁中空缺；移至最後，2026-06-15 使用者指定順延）
