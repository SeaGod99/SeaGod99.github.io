...
| 4.5 | 園藝配種計算 | `/tools/gardening/` | 完成（107種作物／216件花色，06-17新增；**08-12 重做**：目標導向多層配種路徑＋總工期＋收成時刻試算、花色油粕配方、機制速查，新增 `scripts/build-gardening.mjs`，機制查證見 [gardening-rules.md](gardening-rules.md)） |
