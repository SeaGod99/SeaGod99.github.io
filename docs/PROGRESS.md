...
| 4.10 | 無人島素材／工坊查詢 | `/tools/island/` | 完成（07-23 新增，第一期）：三分頁——**工坊生產** 81 筆（時數／價值／每小時／主題／工房等級，可依時數與**製作類型（主題）**篩選、四種排序）／**素材反查** 109 素材依取得方式分組，顯示採集**區域**（中心＋半徑）、農場種植、牧場產出、製作，並反查用途／**採集地圖** 島嶼底圖＋**26 個採集區域**圓圈（48 種素材共用，一區可採多種）、地上洞窟分層。分頁與篩選同步網址可分享 |
