...
**最後更新**：2026-08-27（幻化配裝圖鑑資料更新：Mirapri 6,933→6,953、社群顯示 **6,907 套**，空殼重建 2,297 套、逐件染色 6,162 套；20 張新圖由 Claude 逐張親讀，**名稱 120/120、染色 120/120 全中**。新招式：標籤糊到讀不出來時先找同投稿者的英文版截圖，用英文名回查道具庫取日文正名（見知識庫 §4.34）。對 API 清單 86/98，落差 12 件逐筆查過全是 §4.21 清單污染、沒有一件真的漏讀）
