...
| 4.10 | 無人島素材／製作查詢 | `/tools/island/` | 完成（07-23 新增，第一期）：三分頁——**製作清單** 134 筆配方（人工 28＋經濟型 106，109 筆有台服名可顯示）／**素材反查** 109 素材依取得方式分組（地上採集39・洞窟採集9・農場作物16・牧場畜產9・製作產物9・其他27），顯示採集座標＋開地圖＋收購價＋用途反查／**採集地圖** 島嶼底圖 48 點、地上洞窟分層。分頁與篩選同步網址可分享 |
